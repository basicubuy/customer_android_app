...
import com.ubuyng.app.ubuyapi.adapters.AllProsList;
...
public class AllProsActivity extends AppCompatActivity {
    private EditText et_search;
    AllProsList toperProsAdapter;
    ...
    RecyclerView top_pros_rv, recyclerSuggestion, rvSuggest, cats_rv, toper_pros_rv;
    MyApplication App;
    ...
    private com.ubuyng.app.ubuyapi.Interface.AdapBidsInterface AdapBidsInterface;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_pros);
        ...
        toper_pros_rv = findViewById(R.id.toper_pros_rv);
        toper_pros_rv.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
        toper_pros_rv.setHasFixedSize(true);
        ...
        if (JsonUtils.isNetworkAvailable(this)) {
            ...
            intent = new Intent(AllProsActivity.this , InternetActivity.class);
    ...
    private void runSearch(){
        if (loadingData){
            ...
            if (JsonUtils.isNetworkAvailable(AllProsActivity.this)) {
                loadSearch();
            } else{
    ...
    private void loadSearch() {
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onFailure(Call<String> call, Throwable t) {
                Intent intent = new Intent(AllProsActivity.this, InternetActivity.class);
                startActivity(intent);
    ...
    private void loadSubPros() {
        ...
        UbuyApi ubuyapi = retrofit.create(UbuyApi.class);
        Call<String> call = ubuyapi.getAllPros();
        startAnim();
...
//                    no_bids.setVisibility(View.VISIBLE);
    ...
    private void displayData() {
        topProsAdapter = new HomeTopProsAdapter(AllProsActivity.this, mTopPros);
        top_pros_rv.setAdapter(topProsAdapter);

        toperProsAdapter = new AllProsList(AllProsActivity.this, mTopPros);
        toper_pros_rv.setAdapter(toperProsAdapter);

//        allCatAdapter = new CatAdapter(AllProsActivity.this, mCats);
