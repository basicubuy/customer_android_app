...
public class ExpiredTasksAdapter extends RecyclerView.Adapter<ExpiredTasksAdapter.ItemRowHolder> {
    ...
    public ExpiredTasksAdapter(Context context, ArrayList<ItemProject> dataList) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_expired_project, parent, false);
...
//        final ItemRowHolder holder = ItemRowHolder;
        ...
        holder.lyt_parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("project_status", "Expired task");
