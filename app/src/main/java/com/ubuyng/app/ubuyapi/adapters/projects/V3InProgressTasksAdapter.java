...
public class V3InProgressTasksAdapter extends RecyclerView.Adapter<V3InProgressTasksAdapter.ItemRowHolder> {
    ...
    public V3InProgressTasksAdapter(Context context, ArrayList<ItemProject> dataList) {
