...
public class DisputeTaskAdapter extends RecyclerView.Adapter<DisputeTaskAdapter.ItemRowHolder> {

    private ArrayList<ItemDisputeTask> dataList;
    ...
    public DisputeTaskAdapter(Context context, ArrayList<ItemDisputeTask> dataList, AdapDisputeInterface AdapDisputeInterface) {
    ...
    public void onBindViewHolder(final ItemRowHolder holder, final int position) {
        final ItemDisputeTask singleItem = dataList.get(position);
        holder.list_name.setText(singleItem.getTaskName());
        holder.lyt_parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AdapDisputeInterface.onTaskClick(singleItem.getTaskName(), singleItem.getTaskId(), singleItem.getTaskRef());
            }
        });
