...
public class HomeTopProsAdapter extends RecyclerView.Adapter<HomeTopProsAdapter.ItemRowHolder> {
    ...
    public HomeTopProsAdapter(Context context, ArrayList<ItemPros> dataList) {
