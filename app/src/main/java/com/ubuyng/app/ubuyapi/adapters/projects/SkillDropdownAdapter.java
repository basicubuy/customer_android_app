...
public class SkillDropdownAdapter extends RecyclerView.Adapter<SkillDropdownAdapter.ItemRowHolder> {

    private ArrayList<ItemSkill> dataList;
    ...
    public SkillDropdownAdapter(Context context, ArrayList<ItemSkill> dataList, AdapCatInterface AdapCatInterface) {
    ...
    public void onBindViewHolder(final ItemRowHolder holder, final int position) {
        final ItemSkill singleItem = dataList.get(position);
        holder.list_name.setText(singleItem.getSkillTitle());
        holder.lyt_parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//        Toast.makeText(mContext,singleItem.getItemName(),Toast.LENGTH_LONG).show();
                AdapCatInterface.onSubSkillClick(singleItem.getSkillTitle(), singleItem.getSubId(), singleItem.getSkillId());
