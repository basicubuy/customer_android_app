...
public class SubTopProsAdapter extends RecyclerView.Adapter<SubTopProsAdapter.ItemRowHolder> {
    ...
    public SubTopProsAdapter(Context context, ArrayList<ItemPros> dataList) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_top_pros, parent, false);
...
//        final ItemRowHolder holder = ItemRowHolder;
    ...
    public class ItemRowHolder extends RecyclerView.ViewHolder {
        public CircularImageView user_profile_img;
