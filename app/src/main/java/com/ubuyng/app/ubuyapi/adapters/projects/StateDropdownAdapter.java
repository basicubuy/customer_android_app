...
public class StateDropdownAdapter extends RecyclerView.Adapter<StateDropdownAdapter.ItemRowHolder> {

    private ArrayList<ItemState> dataList;
    ...
    public StateDropdownAdapter(Context context, ArrayList<ItemState> dataList, AdapCatInterface AdapCatInterface) {
    ...
    public void onBindViewHolder(final ItemRowHolder holder, final int position) {
        final ItemState singleItem = dataList.get(position);
        holder.list_name.setText(singleItem.getState());
        holder.lyt_parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AdapCatInterface.onStateClick(singleItem.getState(), singleItem.getStateId());
            }
        });
