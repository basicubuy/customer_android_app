...
public class V3PendingTasksAdapter extends RecyclerView.Adapter<V3PendingTasksAdapter.ItemRowHolder> {
    ...
    public V3PendingTasksAdapter(Context context, ArrayList<ItemProject> dataList) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.v3_content_receiving_project, parent, false);
...
//        final ItemRowHolder holder = ItemRowHolder;
        ...
        holder.project_budget.setText("₦"+singleItem.getProjectBudget());
...
//            now we check if the bid count is lesser than 4
        ...
        /*debugging of chips starts here*/

        holder.chip_skill_1.setText(singleItem.getSkillTitle1());
        /*debugging of chips ends here*/
...
//        public ImageView image;
        ...
        public ItemRowHolder(View itemView) {
            ...
            chip_skill_1 =  itemView.findViewById(R.id.chip_skill_1);
