...
public class SearchActivity extends AppCompatActivity {
    ...
    private LinearLayout lyt_suggestion, recom_lyt;
...
//        initToolbar();
        ...
        if (JsonUtils.isNetworkAvailable(this)) {
            loadCategories();
        Log.i("SUB_LIST", Constant.SEARCH_CAT);
        } else{
    ...
    private void loadCategories() {
        ...
        Call<String> call = ubuyapi.getCategories();
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onFailure(Call<String> call, Throwable t) {
                Intent intent = new Intent(SearchActivity.this, InternetActivity.class);
                startActivity(intent);
...
//                lyt_not_found.setVisibility(View.VISIBLE);
    ...
    private void displaySuggest() {
        ...
        mCatAdapter = new CatAdapter(SearchActivity.this, mCategory);
