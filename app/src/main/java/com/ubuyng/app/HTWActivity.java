...
public class HTWActivity extends AppCompatActivity {
    WebView webView;
    String htmlText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.htw_activity);
        initToolbar();
        webView = findViewById(R.id.webview);
        loading_webview = findViewById(R.id.loading_webview);
        htmlText = "https://ubuy.ng/how-it-works";
        activity_name = findViewById(R.id.activity_name);

        activity_name.setText("How It Works");
        loadHTW();
    }
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.contains("how")) {
                    ...
                    Intent intent = new Intent(HTWActivity.this, ProfileActivity.class);
